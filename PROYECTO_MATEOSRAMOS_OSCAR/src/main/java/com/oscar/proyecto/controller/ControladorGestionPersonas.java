...
public class ControladorGestionPersonas {
    ...
    @FXML private TableColumn<Persona, String> colUsuario;
    @FXML private TableColumn<Persona, Perfil> colPerfil;
    ...
    private void editarPersona() {
        ...
        if (personaSeleccionada != null) {
            ...
            TextField apellidos = new TextField(personaSeleccionada.getApellidos());
            TextField usuario = new TextField(personaSeleccionada.getUsuario());
            PasswordField contraseña = new PasswordField();
            contraseña.setPromptText("Deja vacío para mantener la contraseña actual");
            ComboBox<Perfil> perfil = new ComboBox<>();
            perfil.getItems().setAll(Perfil.values());
            ...
            dialog.setResultConverter(dialogButton -> {
                if (dialogButton == guardarButtonType) {
                    ...
                    if (!contraseña.getText().isEmpty()) {
                        personaSeleccionada.setContraseña(contraseña.getText()); // Se cifrará en el servicio
                    }
