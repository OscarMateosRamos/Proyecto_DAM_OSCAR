...
public class Profesor extends Persona {
	...
	public Profesor(String codigoProfesor, String departamento, String email,
			...
			String aulaAsignada, boolean esCoordinador, LocalDate fechaIngreso,
			List<Curso> cursosAsignados,
			List<FormacionEmpresa> formacionesCoordinadas) {
		super();
	...
	public void setFormacionesCoordinadas(
			List<FormacionEmpresa> formacionesCoordinadas) {
		this.formacionesCoordinadas = formacionesCoordinadas;
	}
